...
public class myDirectedWeightedGraph implements DirectedWeightedGraph {
    ...
    public EdgeData removeEdge(int src, int dest) {
        ...
        if (edgesOfNode.get(src) != null)
            edgesOfNode.get(src).fromMe.remove(dest);


        if (edgesOfNode.get(dest) != null)
    ...
    private class Edge_Iterator_OfNode implements Iterator<EdgeData> {
        public int mc;
        public Iterator<EdgeData> EdgeOfNodeIter;
        public EdgeData edgePerNode;
